...
def user_input_features():
    # Collect all 12 features expected by the model (in order)
    ...
    with col1:
        ...
        resolution = st.number_input('Resolution (ppi)', min_value=1, max_value=100, value=50)
    ...
    with col2:
        ...
        ram = st.selectbox('RAM (MB)', [1, 2, 3, 4, 5, 6, 7, 8])
        ...
        battery = st.number_input('Battery (mAh)', min_value=500, max_value=15000, value=2610)
    ...
    features = np.array([[
         sale, weight, resolution, ppi, cpu_core, cpu_freq, 
